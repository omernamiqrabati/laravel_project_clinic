...
@section('content')
    <div class="max-w-4xl mx-auto">
        <div class="bg-white shadow-lg rounded-3xl p-8 border border-gray-100">
            ...
            <form action="{{ route('admin.treatments.update', $treatment['treatment_id']) }}" method="POST" class="space-y-8">
                @csrf
                @method('PUT')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <p class="text-gray-600 text-sm flex items-center">
                                ...
                                Leave empty if duration is flexible
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="space-y-2">
                        <label class="flex items-center p-4 bg-white rounded-xl border-2 border-gray-200 hover:border-purple-300 transition-all duration-300 cursor-pointer">
                            ...
                            <div>
                                ...
                                <span class="text-gray-600 text-sm">Uncheck to disable this treatment from being selected</span>
                            </div>
                        </label>
                    </div>
                </div>
