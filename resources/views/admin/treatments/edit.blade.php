...
@section('content')
    <div class="container mx-auto px-4 py-6">
        <div class="max-w-2xl mx-auto">
            <h1 class="text-3xl font-bold mb-6">Edit Treatment</h1>
            ...
            <form action="{{ route('admin.treatments.update', $treatment['treatment_id']) }}" method="POST" class="bg-white shadow-md rounded px-8 pt-6 pb-8 space-y-6">
                @csrf
                @method('PUT')
                ...
                <div>
                    ...
                    <textarea name="description" 
                              ...
                              maxlength="1000">{{ old('description', $treatment['description']) }}</textarea>
                    @error('description')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    @error('duration_minutes')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                    <p class="text-gray-500 text-sm mt-1">Leave empty if duration is flexible</p>
                </div>
                ...
                <div>
                    ...
                    <p class="text-gray-500 text-sm mt-1">Uncheck to disable this treatment from being selected</p>
                </div>
