...
@section('content')
    <div class="max-w-4xl mx-auto">
        <div class="bg-white shadow-lg rounded-3xl p-8 border border-gray-100">
            ...
            <form action="{{ route('admin.receptionists.update', $receptionist['receptionist_id']) }}" method="POST" enctype="multipart/form-data" class="space-y-8">
                @csrf
                @method('PUT')
                ...
                <div class="bg-gradient-to-r from-purple-50 to-pink-50 p-6 rounded-2xl border border-purple-100">
                    ...
                    <div id="currentAvatarContainer" class="mb-4" @if(!isset($receptionist['avatar']) || is_null($receptionist['avatar']) || trim($receptionist['avatar']) === '') style="display: none;" @endif>
