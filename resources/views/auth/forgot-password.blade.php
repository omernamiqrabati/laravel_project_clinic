...
<body class="dental-pattern">
    <div class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div class="max-w-md w-full space-y-8 relative z-10">
            ...
            <!-- Enhanced Reset Password Form Card -->
            <div class="glass-card py-8 px-8 rounded-3xl">
                ...
                <div class="text-center mb-8">
                    ...
                    <p class="text-gray-600 mt-2 font-medium">Enter your email address and we'll send you a secure link to reset your password</p>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            <input id="email" name="email" type="email" required 
                                   class="input-focus appearance-none rounded-xl relative block w-full px-4 py-4 border-2 border-gray-200 placeholder-gray-400 text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-300 @error('email') border-red-400 focus:ring-red-500 focus:border-red-500 @enderror" 
                        ...
                        <button type="submit" 
                            ...
                            <span class="absolute left-0 inset-y-0 flex items-center pl-4">
                                <svg class="h-6 w-6 text-blue-200 group-hover:text-white transition duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 2.26a2 2 0 01.22.08l8.89 2.26A2 2 0 0122 14v5a2 2 0 01-2 2H4a2 2 0 01-2-2v-5a2 2 0 011.11-1.79l8.89-2.26a2 2 0 01.22-.08L20 8"></path>
                                </svg>
                            </span>
